...
<script type="text/javascript">
		...
		function addObj(){
			var flag=$("#flag").val();
			var url="<%=request.getContextPath()%>/pages/ftpdirConfig/form/edit?flag="+flag;
		...
		function modObj(id){
			var flag=$("#flag").val();
			var url="<%=request.getContextPath()%>/pages/ftpdirConfig/form/edit?eid="+id+"&flag="+flag;
			var top=document.body.offsetHeigth/2;
			var left=document.body.offsetWIdth/2;
			var width="600px";
			var height="350px";
		...
		function delObj(id){
			if(window.confirm("<ingenta-tag:LanguageTag sessionKey='lang' key='Pages.Ftpdir.Prompt.Delete'/>")){//您确定删除的FTP文件夹配置信息?
...
<div class="bodyDiv bodyNew" style="position:relative;">
	...
	<table width="95%" border="0" cellpadding="0" cellspacing="1" class="tab02">
       <tr>
       	 <th width="8%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.Ftp.Table.Lable.Ftpname"/>：</th>
         <td width="18%">
         	<form:input path="name" cssStyle="width:98%" id="name"/>
         </td>
         
         <th width="8%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.Ftp.Table.Lable.PackName"/>：</th>
         <td width="18%">
         	<form:input path="dirName" cssStyle="width:98%" id="dirName"/>
         </td>
   ...
   <input type="button" value="<ingenta-tag:LanguageTag sessionKey="lang" key="Global.Button.Inquiry"/>" class="devil_button" onclick="query()"/>
     	...
     	<table width="95%" border="0" cellpadding="0" cellspacing="1" class="devil_table">
     		...
     		<tr>
		        ...
		        <th width="20%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.Ftp.Table.Lable.Ftpname"/></th>
		        <th width="20%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.Ftp.Table.Lable.PackName"/></th>
		        <th width="15%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.Ftp.Table.Lable.Dir"/></th>
		        <th width="15%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.Ftp.Table.Lable.Description"/></th>
